...
use bevy::ecs::reflect::{ReflectGetTemplate, ReflectTemplate};
...
#[derive(Clone, Component, Debug, Reflect, GetTemplate)]
#[reflect(Clone, Component, GetTemplate)]
#[template(reflect)]
...
fn dump(
    ...
    for (
        ...
        maybe_name,
        maybe_test_struct,
        maybe_handle_container,
        maybe_cascade_shadow_config,
    ) in &query
    {
        println!(
            "{:?} {:?} {:?} {:?}, {:?}",
            ...
            maybe_name,
            maybe_test_struct,
            maybe_handle_container.is_some(),
            maybe_cascade_shadow_config,
        );
    }
}
